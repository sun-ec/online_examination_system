...
<div id="wrapper">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li><a href="test/findAllExamNo?type=maintain"><i class="fa fa-plus-square"></i>考卷维护</a></li>
                    </ul>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
       ...
       <div>
               ...
               <br>
               <button style="margin-left: 76px" class="btn btn-info " id="stest" type="button"><i class="fa fa-paste"></i>维护</button>
...
<script>
    $(function () {
        ...
        $('#stest').click(function () {
            $.post("test/showPaper",
                {"examNo":$('#exam_no option:selected').val()},
                function (jsonData) {
                if(jsonData.status){
                    window.location.href="papersMaintain1.jsp";
                }else{
                    swal({
                        title: "维护失败",
                        icon: "error"
            ...
            $.post("test/addExam",
                {"exa":$('#exam_no option:selected').val()},"json"
            )
        })
    })
</script>

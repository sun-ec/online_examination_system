            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="addMultipleChoiceForm.jsp"><i class="fa fa-plus-square"></i>新增多选题</a></li>
                        ...
                        <div class="col-md-12 ">
                            <div class="ibox float-e-margins">
                                <div class="ibox-content">
                                    <a href="multipleSelectForm.jsp">
                                        <button style="position:absolute;left: -150px" class="btn btn-primary" type="submit">查询选题</button>
                                    </a>
                                    <form id="MultipleChoice" method="post" action="test/addChoice2" class="form-horizontal">
                                        <div class="form-group"><label class="col-sm-2 control-label">多选题题干</label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-10" style="margin-left: 120px">
                                                <button onclick="myCopy()" type="button" class="btn btn-w-m btn-default" style="min-width:60px">复制格式代码</button>
                                            </div>
                                        </div>
                                        <div><label class="col-sm-2 control-label">课程</label>
                                            ...
                                            <select style="width: 222px;height: 154px;position: absolute;left: 440px;top: 423px" name="techCateId" multiple class="form-control">
                                            </select>
                                        </div>
                                        <div>
                                        ...
                                        <div class="form-group"><label class="col-sm-2 control-label">A</label>
                                            ...
                                            <input style="position: relative;top: -8px;left: 20px" type="checkbox"

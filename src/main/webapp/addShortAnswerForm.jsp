            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="addShortAnswerForm.jsp"><i class="fa fa-plus-square"></i>新增简答题</a></li>
                        ...
                        <div class="col-md-12 ">
                            <div class="ibox float-e-margins">
                                <div class="ibox-content">
                                    <a href="shortSelectForm.jsp">
                                        <button style="position:absolute;left: -150px" class="btn btn-primary" type="submit">查询选题</button>
                                    </a>
                                    <form id="short" method="post" action="test/addSimpleAnwser4" class="form-horizontal">
                                        <div><label class="col-sm-2 control-label">课程</label>
                                            ...
                                            <select style="width: 222px;height: 154px;position: absolute;left: 440px;top: 16px" name="techCateId" multiple class="form-control">
                                            </select>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">简答题题干</label>
                                            <div class="col-sm-10"><textarea style="margin-left: -5px" name="question"  cols="60"
                                                                             rows="5"></textarea></div>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">标准答案</label>
                                            <textarea style="margin-left: 10px" name="correct"  cols="58" rows="5"></textarea>
                                        </div>

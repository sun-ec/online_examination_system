...
<div id="wrapper">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li><a href="test/findAllExamNo?type=''"><i class="fa fa-plus-square"></i>考试</a></li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div>
                ...
                <button type="submit" name="chooes" class="btn btn-w-m btn-primary" style="min-width:50px">选择</button>
                <br>
                <button style="margin-left: 76px" class="btn btn-info " id="stest" type="button"><i class="fa fa-paste"></i>设置</button>
                <button class="btn btn-default " type="reset"><i class="fa-exchange"></i>&nbsp;&nbsp;重置</button>
                <br>
...
$('#stest').click(function () {
    $.post("test/addExam",
        {"exa":$('#exam_no option:selected').val()},
        function (jsonDate) {
            if(jsonDate.status){
                swal({
                    title: "设置成功",

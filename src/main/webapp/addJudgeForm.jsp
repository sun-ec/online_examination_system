            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="addJudgeForm.jsp"><i class="fa fa-plus-square"></i>新增判断题</a></li>
                        ...
                        <div class="col-md-12 ">
                            <div class="ibox float-e-margins">
                                <div class="ibox-content">
                                    <a href="judgeSelectForm.jsp">
                                        <button style="position:absolute;left: -150px" class="btn btn-primary" type="submit">查询选题</button>
                                    </a>
                                    <form id="JudgeChoice" method="post" action="test/addTrueFalse" class="form-horizontal">
                                        <div><label class="col-sm-2 control-label">课程</label>
                                            ...
                                            <select style="width: 222px;height: 154px;position: absolute;left: 440px;top: 15px" name="techCateId" multiple class="form-control">
                                            </select>
                                        </div>
                                        <div>
                                            <lable style="margin-left: 280px">内容</lable>
                                            <lable style="margin-left: 230px">正确答案</lable>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label"></label>
                                            <textarea style="margin-left: 10px" name="question" id="rf" cols="50" rows="2"></textarea>
                                            <input style="position: relative;top: -30px;left: 20px" type="radio"
                                                   name="correct" value="对"><b style="position: absolute;left: 620px">对</b>
                                            <input style="position: relative;top: -8px;left: 3px" type="radio"
                                                   name="correct" value="错"><b style="position: absolute;left: 620px;top: 240px">错</b>
                                        </div>

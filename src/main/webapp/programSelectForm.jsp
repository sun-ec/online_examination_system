            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li  class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li  class="active"><a href="test/querySimple5"><i class="fa fa-newspaper-o"></i>编程题查询</a></li>
                    </ul>
                </li>
                <li>
                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-content">
                                    ...
                                    <form id="program" method="post" action="#" class="form-horizontal"
                                        ...
                                        <div class="form-group"><label style="position: relative;left: -565px">编程题题干</label>
                                        ...
                                        <div><label class="col-sm-2 control-label">课程</label>
                                            <select style="width: 222px;height: 154px" name="course" multiple class="form-control">
                                                <!-- <c:forEach item="" var="">
                                               <option>1</option>
                                               </c:forEach>-->
                                            </select>
                                            <label style="position: relative;left: 350px;top: -145px">知识点</label>
                                            <select style="width: 222px;height: 154px;position: absolute;left: 440px;top: 60px" name="knowledge" multiple class="form-control">
                                                <!-- <c:forEach item="" var="">
                                               <option>1</option>
                                               </c:forEach>-->
                                            </select>
                                        ...
                                        <form action="#" method="post">
                                            考卷编码：<input type="text" name="exam_no">
                                            <button type="submit" class="btn btn-w-m btn-primary" style="min-width:50px">选择</button>
                                            <br>

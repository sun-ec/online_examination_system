            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="addProgrammingForm.jsp"><i class="fa fa-plus-square"></i>新增编程题</a></li>
                    </ul>
                </li>
                <li>
                        ...
                        <div class="col-md-12 ">
                            <div class="ibox float-e-margins">
                                <div class="ibox-content">
                                    ...
                                    <form id="program" method="post" action="test/addSimpleAnwser5" class="form-horizontal">
                                        <div><label class="col-sm-2 control-label">课程</label>
                                            ...
                                            <select style="width: 222px;height: 154px;position: absolute;left: 440px;top: 30px" name="techCateId" multiple class="form-control">
                                            </select>
                                        </div>
                                        <div class="form-group"><label class="col-sm-2 control-label">编程题题干</label>

            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="test/queryTrueFalse"><i class="fa fa-newspaper-o"></i>判断题查询</a></li>
                            ...
                            <div class="ibox float-e-margins">
                                <div class="ibox-content">
                                    ...
                                    <form id="program" method="post" action="#" class="form-horizontal"
                                        ...
                                        <div class="form-group"><label style="position: relative;left: -565px">判断题题干</label>
                                        ...
                                        <div id="view1">
                                            <c:forEach var="item" items="${page}" varStatus="status">
                                                    <input type="checkbox" name="question" value="${item.question}">${status.index+1}.${item.question}<br>
                                            </c:forEach>
                                        ...
                                        <div id="view2" style="display: none">
                                           <c:forEach var="item" items="${page}" varStatus="status">
                                                ...
                                                <input type="checkbox" name="questiond" value="${item.question}">${status.index+1}.${item.question}<br>
                                                <b style="color: red">答案：${item.correct}</b>
                ...
                <div class="modal-content animated flipInY">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal text-center" role="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" style="margin-top: 3.5%">答案：</label><br>
                                <div class="col-sm-8">
                                  <lable>对：</lable><input type="radio"  id="true"  name="answer">
                                  <lable>错：</lable><input type="radio"  id="flase"  name="answer">
                                </div>
                            </div>
                        </form>
                    </div><!--模态框内容结束-->

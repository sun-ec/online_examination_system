            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    <a href="#"><i class="fa fa-book"></i> <span class="nav-label">试题查询</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="active"class="active"><a href="test/queryChoice1"><i class="fa fa-file-text"></i>单选题查询</a></li>
                    ...
                    <div class="row  border-bottom white-bg dashboard-header">
                        <div class="col-md-12 ">
                            <div class="ibox float-e-margins">
                                    ...
                                    <a href="addSingleChoiceForm.jsp"><button style="position:absolute;left: -150px" class="btn btn-primary" type="button">继续新增</button></a>

                                    <form class="ibox-content" id="program" method="post" action="test/queryChoice1" >
                                        <div class="form-group"><label style="position: relative;left: -540px;top: 5px;">单选题题干</label>
                                            <div class="col-sm-10"><input type="text" name="question" style="width: 350px;margin-left: 100px"><b>(模糊查询)</b></div>
                                        </div>
                                        <div><label class="col-sm-2 control-label" style="position:relative;left: 10px;top: 8px;width: 80px">课程</label>
                                            ...
                                            <select style="width: 222px;height: 154px;position: absolute;left: 440px;top: 56px" name="techCateId" multiple class="form-control">
                                            </select>
                                        </div>
                ...
                <form class="form-horizontal text-center" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1" style="margin-top: 1%">
                            <input type="radio" id="correctA" name="correct" value="A">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1" style="margin-top: 1%">
                            <input type="radio" id="correctB" name="correct" value="B">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1" style="margin-top: 1%">
                            <input type="radio" id="correctC" name="correct" value="C">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1" style="margin-top: 1%">
                            <input type="radio" id="correctD" name="correct" value="D">
                        </div>
                    </div>
                </form>
            </div><!--模态框内容结束-->
    ...
    function myUpdate(){
        $.post("test/updateChoice",
            ...
            if(jsonData.status){
                ...
                $("#tr_"+$('#id').val()).find("b").eq(4).text('答案：'+$("input[name='correct']:checked").val());
            }else{
                swal({
                    title: "更新失败",
                    icon: "error"
